...
class DisBatcher(object):
    ...
    def __init__(self, hps, vocab, train_path_positive, train_path_negetive, test_path_positive, test_path_negetive):
        self._vocab = vocab
        self._hps = hps
...
class Example(object):
    ...
    def __init__(self, review, label, vocab, hps):
        ...
        abs_ids = [[vocab.word2id(w) for w in sen] for sen in article_words] 
        ...
        self.dec_input, self.target = self.get_dec_inp_targ_seqs(
            ...
            start_decoding,
            stop_doc
            )  # max_sen_num,max_len, start_doc_id, end_doc_id,start_id, stop_id
