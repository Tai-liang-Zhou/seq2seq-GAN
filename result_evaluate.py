...
class Evaluate(object):
    ...
    def diversity_evaluate(self, data_path):
        ...
        if self.bigram_num == 0:
            tf.logging.info("bigram number: " + str(self.bigram_num) + " unique bigram number: " + str(len(self.all_bigram)) + " unique bigram rate: " + str(0))
        else:
            tf.logging.info("bigram number: " + str(self.bigram_num) + " unique bigram number: " + str(len(self.all_bigram)) + " unique bigram rate: " + str(len(self.all_bigram) / (1.0 * self.bigram_num)))
        
        if self.trigram_num == 0:
            tf.logging.info("trigram number: " + str(self.trigram_num) + " unique trigram number: " + str(len(self.all_trigram)) + " unique trigram rate: " + str(0))
        else:
            tf.logging.info("trigram number: " + str(self.trigram_num) + " unique trigram number: " + str(len(self.all_trigram)) + " unique trigram rate: " + str(len(self.all_trigram) / (1.0 * self.trigram_num)))